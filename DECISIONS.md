...
**Options considered:** re-derive AC-05 to fork-parity against an UPSTREAM_BASE control / additionally fix the `.vitepress/dist` eslint ignore gap (an upstream edit needing an allowance widening) / escalate and leave Task 7 blocked
